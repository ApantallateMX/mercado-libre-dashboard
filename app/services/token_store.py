    ...
    async with aiosqlite.connect(DATABASE_PATH) as db:
        ...
        await db.execute("""
            CREATE TABLE IF NOT EXISTS bm_sku_gaps (
                ...
                stock_mty       INTEGER NOT NULL DEFAULT 0,
                stock_cdmx      INTEGER NOT NULL DEFAULT 0,
                ...
                cost_price_mxn  REAL NOT NULL DEFAULT 0,
                competitor_price REAL NOT NULL DEFAULT 0,
                competitor_count INTEGER NOT NULL DEFAULT 0,
                deal_price      REAL NOT NULL DEFAULT 0,
                listing_type_rec TEXT NOT NULL DEFAULT 'gold_special',
