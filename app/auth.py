...
async def amazon_connect(request: Request, seller_id: str = None):
    ...
    # AMAZON3 (ExclusiveBulbs) usa el app Production de AMAZON2 (Claude Autobot Dashboard)
    # porque Claude Exclusive es Sandbox y no puede acceder a datos reales.
...
async def amazon_callback(
    ...
    if _is_acct3:
        # ExclusiveBulbs usa el app Production de AMAZON2 (Claude Autobot Dashboard)
        # porque Claude Exclusive es Sandbox. Exchange con creds de AMAZON2.
